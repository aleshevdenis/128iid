...
module Kenna
  module 128iid
    class WhitehatSentinelTask < Kenna::128iid::BaseTask
      ...
      def run(options)
        ...
        mapper = Kenna::128iid::WhitehatSentinel::Mapper.new(scoring_system)

        client = Kenna::128iid::WhitehatSentinel::ApiClient.new(api_key: key, page_size: page_size)
      ...
      rescue Kenna::128iid::WhitehatSentinel::ApiClient::Error
